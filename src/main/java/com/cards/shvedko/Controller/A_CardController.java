...
//        translatedWord.setText(.getForeignName());
    ...
    public void handleEditCardButton(ActionEvent actionEvent) {
        ...
        switch (cards.getType().getName()) {
            case ModelsDAO.NOUN:
                openOneMoreWindow("ManageCards/Edit/editCardNoun.fxml", A_Controller.EDIT_NOUN_PAGE, cards, actionEvent);
                break;
            case ModelsDAO.VERB:
                openOneMoreWindow("ManageCards/Edit/editCardVerb.fxml", A_Controller.EDIT_VERB_PAGE, cards, actionEvent);
                break;
            case ModelsDAO.ADJECTIVE:
                openOneMoreWindow("ManageCards/Edit/editCardAdjective.fxml", A_Controller.EDIT_ADJECTIVE_PAGE, cards, actionEvent);
                break;
            case ModelsDAO.ADVERB:
                openOneMoreWindow("ManageCards/Edit/editCardAdverb.fxml", A_Controller.EDIT_ADVERB_PAGE, cards, actionEvent);
                break;
            case ModelsDAO.NUMERAL:
                openOneMoreWindow("ManageCards/Edit/editCardNumeral.fxml", A_Controller.EDIT_NUMERAL_PAGE, cards, actionEvent);
                break;
            case ModelsDAO.PARTICIPLE:
                openOneMoreWindow("ManageCards/Edit/editCardParticiple.fxml", A_Controller.EDIT_PARTICIPLE_PAGE, cards, actionEvent);
                break;
            case ModelsDAO.PRONOUN:
                openOneMoreWindow("ManageCards/Edit/editCardPronoun.fxml", A_Controller.EDIT_PRONOUN_PAGE, cards, actionEvent);
                break;
            default:
                openOneMoreWindow("ManageCards/Edit/editCardOther.fxml", A_Controller.EDIT_OTHER_PAGE, cards, actionEvent);
                break;
        }
    }
